...
try
    {       
       out.println("<h2>List Updated successfully! </h2> <br />");
        int c=1;
        ...
        while((strLine=br.readLine())!=null)
        {
             ...
             StringTokenizer tokenizer = new StringTokenizer(strLine," ");
                ...
                {               
                    ...
                    C.add(tokenizer.nextToken()+" "+tokenizer.nextToken());
         ...
         for(int i=0;i<A.size();i++)
            {
                ...
                obj.setCabcolor(e);
                obj.setStatus(f);
                System.out.println(AppDao.InsertCabDetails(sql, obj));
          }
    ...
    <div class="col-lg-10 col-lg-offset-1">
                ...
                <table class="table table-striped table-hover" width="635" height="68">
                 <thead class="thead-inverse">
                    <tr>
                            <th width="18">CAB ID</th>
                            <th width="104">CAB NAME</th>
                            <th width="154">CAB NUMBER</th>
                            <th width="94">CAB TYPE</th>
                            <th width="112">NSEATS </th>
                            <th width="76">CAB COLOR</th>
