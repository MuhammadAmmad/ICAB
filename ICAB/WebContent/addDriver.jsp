...
<head>
    ...
    <div class="container">
        <center>
            <div class="row">
                <div class="box">
                    <div class="cols-lg-12">
                        <hr> <h2>UPLOAD DRIVER Details from CSV file.</h2> <hr>
                        <form enctype="multipart/form-data" method="post" action="UploadingDriver.jsp" class="form-inline">
                          <br />
                          <div class="form-group">
                            <input type="file" class="form-control input-lg input-md" name="upload" />
                            <small class="text-muted">The name of the file to be uploaded is driver.txt</small>
                    		</div>
                    <br /> <br />
                    <div class="form-group">
            ...
            <br /> 
            <br />
            <hr> <h2>ADD Driver Details </h2> <hr> 
            <br />
            <form action="InsertDriverServlet" method="post" class="col-xs-12">
            <center>
                <div class="form-group row">
                    <label class="col-sm-offset-3 col-sm-2 form-control-label"> Full Name </label>
                    <div class="col-sm-4">
                        <input required type="text" name="dname" class="form-control" placeholder="Driver's Full Name">
                    </div>
                </div>
                </center>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input required type="text" name="dno" class="form-control" placeholder="Driver's Mobile number">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="email" name="demail" class="form-control" placeholder="Driver's Email">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input required type="date" name="ddob" class="form-control">
