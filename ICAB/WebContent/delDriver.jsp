...
<head>
    ...
    <div class="container">
        <center>
            <div class="row">
                <div class="box">
                    <div class="cols-lg-12">
                        <hr> <h2>DELETE DRIVER by ID</h2> <hr>
                        <form method="post" action="DeleteDriverServlet" class="form-inline">
                          <br />
                     ...
                     <br />   <br />     
                     <div class="form-group">
                        <button type="submit" class="btn btn-lg btn-danger">Delete Driver</button> 
                    </div>
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <form method="post" action="DeleteDriverServlet">
                    ...
                    <tbody>
                        ...
                        %>
                        <tr>
                            <td><input type="radio" value="<%=ds.getString(1) %>" name="id"  ></td>
            ...
            <br /> <button type="submit" class="btn btn-lg btn-danger">Delete Driver</button>
            <br /> <br /> <br />
