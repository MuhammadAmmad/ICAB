     ...
     <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12">
                        <div class="col-lg-12">
                        <a href="addCab.jsp" class="btn btn-lg btn-block btn-success" role="button">
                        <h2> <span class="glyphicon glyphicon-cloud-upload"></span> <br /><br />
                        Add Cab details </h2> </a>
                        </div>
                        <div class="col-lg-12">
                        <a href="updateCab.jsp" class="btn btn-responsive btn-lg btn-block btn-warning" role="button">
                        <h2> <span class="glyphicon glyphicon-collapse-up"></span> <br /><br />
                        Update Cab details </h2> </a>
                        </div>
                        <div class="col-lg-12">
                        <a href="delCab.jsp" class="btn btn-lg btn-block btn-danger" role="button">
                        <h2> <span class="glyphicon glyphicon-trash"></span> <br /><br />
                        Delete Cab details </h2> </a>
                        </div>
                        <div class="col-lg-12">
                        <a href="displayCabs.jsp" class="btn btn-lg btn-block btn-primary" role="button">
                        <h2> <span class="glyphicon glyphicon-th-list"></span> <br /><br />
                        View Cab details </h2> </a>
                        </div>
                    <hr>
                </div>
			<br />
