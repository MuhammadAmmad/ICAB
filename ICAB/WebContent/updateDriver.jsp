        ...
        <center>
            <div class="row">
                <div class="box">
                    <div class="cols-lg-12">
                        <hr> <h2>UPDATE DRIVER DETAILS</h2> <hr>
                        <form method="post" action="updateDriver.jsp" class="form-inline">
                          <br />
                          <div class="form-group">
                              <select name="did" class="form-control">
                                 <%
                                 out.println("<option selected='selected' value='Select driverId'>Select driverId</option>");
                                 String sql = "select did from driver";
                         ...
                         <small class="text-muted">You can update various fields of each driver.</small>
                     </div>  
                     <br /> <br />        
                     <div class="form-group">
            ...
            <%
                ...
                if (request.getParameter("did")!= null)
                {
                    ...
                    if(!did.equals("Select driverId"))
                    {
                    System.out.println(did);
                    String sql1 = "select * from driver where did=?";
                    ds1 = AppDao.fetchAllRecordsID(sql1, did);
    
                    while (ds1.next()) {
            %>
            <div class="col-lg-10 col-lg-offset-1">
            <form action="UpdateDriverServlet" method="post" class="col-xs-12">
            <div class="form-group row">
            <input type="hidden" name="did"  value="<%=ds1.getString(1)%>"/>
            </div>
                <div class="form-group row">
                    <label class="col-sm-offset-3 col-sm-2 form-control-label"> Full Name </label>
                    <div class="col-sm-4">
                        <input required type="text" name="dname" class="form-control" value="<%=ds1.getString(2)%>">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-offset-3 col-sm-2 form-control-label"> Email </label>
                    <div class="col-sm-4">
                        <input type="email" name="demail" class="form-control" value="<%=ds1.getString(3)%>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input required type="date" name="ddob" class="form-control" value="<%=ds1.getString(4)%>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input required type="text" name="dno" class="form-control" value="<%=ds1.getString(5)%>">
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-sm-4 ">
                        <input required type="text" name="dcity" class="form-control" value="<%=ds1.getString(6)%>">
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-sm-4 ">
                        <input required type="text" name="status" class="form-control" value="<%=ds1.getString(7)%>">
